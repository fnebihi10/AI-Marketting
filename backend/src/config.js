...
exports.config = {
    ...
    ffmpegPath: process.env.FFMPEG_PATH || node_path_1.default.join(rootDir, 'bin/ffmpeg.exe'),
    ffprobePath: process.env.FFPROBE_PATH || node_path_1.default.join(rootDir, 'bin/ffprobe.exe'),
